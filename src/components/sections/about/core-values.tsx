      ...
      <div className="relative z-10">
        ...
        <Reveal>
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs font-semibold tracking-[0.22em] text-indigo-600 uppercase">
              Core Values
            </span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.02] text-gray-900">
            What guides <span className="text-indigo-600">my work</span>
          </h2>
          <p className="mt-5 text-base text-gray-500 max-w-lg leading-relaxed">
        ...
        <Reveal delay={0.1}>
          <m.div
            ...
            initial="hidden"
            animate="visible"
            className="relative mt-12 sm:mt-14 rounded-3xl border border-gray-200 bg-white overflow-hidden"
          ...
          >
            ...
            {VALUES.map((value, i) => (
              ...
              >
                {/* Left accent bar */}
                <span className="absolute left-0 top-0 bottom-0 w-[3px] bg-indigo-500 scale-y-0 group-hover:scale-y-100 origin-center transition-transform duration-300" />

                {/* Index numeral */}
                <span className="hidden sm:block font-mono text-4xl font-semibold text-gray-200 group-hover:text-indigo-200 transition-colors duration-300 tabular-nums">
                  {(i + 1).toString().padStart(2, "0")}
                </span>

                {/* Icon */}
                <div className="flex-shrink-0 h-11 w-11 sm:h-12 sm:w-12 rounded-2xl bg-indigo-500/10 flex items-center justify-center text-indigo-600 transition-transform duration-300 group-hover:scale-105">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm sm:text-base text-gray-500 leading-relaxed max-w-md">
                    {value.text}
                  </p>
                </div>
              </m.div>
        ...
        {/* ==========================================
            ...
            ========================================== */}
        <Reveal delay={0.2}>
          <div className="mt-8 flex flex-wrap justify-center items-center gap-x-4 gap-y-1.5 text-xs text-gray-400">

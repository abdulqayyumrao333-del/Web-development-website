import { Layers, Server, Sparkles, Database, Wrench, ArrowRight } from "lucide-react";
...
// Confirmed by Abdul — corrected from the initial draft (removed tools not
// actually used in production: GSAP, BullMQ, Redis, RAG/Vector Search, Vite).
const SKILL_GROUPS = [
  {
    group: "Frontend",
    icon: Layers,
    description: "Building interactive, responsive interfaces.",
    tools: ["HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "React", "Next.js", "Tailwind CSS", "Framer Motion"],
  ...
  },
  {
    ...
    tools: ["Node.js", "Express.js", "Next.js Server Actions", "REST APIs", "NextAuth.js"],
    color: "from-indigo-500/20 to-purple-500/20",
  },
  {
    group: "AI & Automation",
    icon: Sparkles,
    description: "AI-integrated features and workflow automation.",
    tools: ["OpenAI API", "Anthropic API", "Groq API", "Prompt Engineering", "AI Chatbots", "Workflow Automation"],
  ...
  },
  {
    ...
    tools: ["PostgreSQL", "Prisma ORM", "MySQL", "Supabase"],
    color: "from-emerald-500/20 to-teal-500/20",
  },
  {
    group: "Tools",
    icon: Wrench,
    description: "Day-to-day engineering tooling.",
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="relative mb-4">
              <h2 className="relative text-h2 font-semibold tracking-tight leading-tight">
                What I
                <br />
                <span className="text-accent-indigo">work with</span>
              </h2>
            </div>

            <p className="text-base text-text-secondary leading-relaxed mt-3 max-w-[14rem]">
              A curated list of technologies and tools I use daily.
            </p>
            ...
            <div className="mt-6 flex items-stretch gap-3">
              ...
              <div className="space-y-2.5 text-xs text-text-muted font-mono">
                ...
                <p className="flex items-center gap-1.5">
                  ...
                  {SKILL_GROUPS.reduce((acc, g) => acc + g.tools.length, 0)} tools
                </p>
                <p className="flex items-center gap-1.5">
            ...
            <div className="mt-8 hidden lg:flex flex-col gap-1.5">
              {SKILL_GROUPS.map((group, i) => (
                <div key={group.group} className="flex items-center gap-2 group cursor-default">
                  ...
                  <group.icon className="h-3 w-3 text-accent-indigo/20 group-hover:text-accent-indigo/40 transition-colors" strokeWidth={1.75} />
        ...
        <Reveal delay={0.1}>
          <div className="relative">
            ...
            <div className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-2">
              {SKILL_GROUPS.map(({ group, icon: Icon, description, tools, color }, i) => (
                    ...
                    <div className="relative flex-1 flex flex-col">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-text-muted/50 group-hover:text-text-muted/70 transition-colors">
                            {description}
                          </p>
                        </div>
                        <span className="ml-auto font-mono text-[7px] text-accent-indigo/8 group-hover:text-accent-indigo/20 transition-colors">
                          {String(i + 1).padStart(2, "0")}
                        </span>
                      </div>
            ...
            <div className="mt-3.5 flex items-center justify-between rounded-lg border border-accent-indigo/10 bg-accent-indigo/[0.025] px-4 py-2.5">
              <p className="font-mono text-[11px] text-text-muted">
                SKILLS · {SKILL_GROUPS.length} CATEGORIES · FULL STACK
              </p>

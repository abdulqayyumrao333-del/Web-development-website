import { Search, ClipboardList, Palette, Code2, TestTube2, Rocket, LifeBuoy, Sparkles, ArrowRight } from "lucide-react";
import { Reveal } from "@/components/sections/reveal";

const STAGES = [
  { icon: Search, title: "Discovery", text: "Understanding the problem and constraints before writing anything." },
  { icon: ClipboardList, title: "Planning", text: "Scoping features, architecture, and timeline." },
  { icon: Palette, title: "Design", text: "Wireframes and visual direction, agreed before build." },
  { icon: Code2, title: "Development", text: "Iterative builds with regular check-ins." },
  { icon: TestTube2, title: "Testing", text: "Cross-browser, responsive, and edge-case checks." },
  { icon: Rocket, title: "Deployment", text: "Shipped to production with monitoring in place." },
  { icon: LifeBuoy, title: "Support", text: "Available post-launch for fixes and iteration." },
];
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="relative mb-4">
              <h2 className="relative text-h2 font-semibold tracking-tight leading-tight">
                How I
                <br />
                <span className="text-accent-indigo">work</span>
              </h2>
            </div>

            <p className="text-base text-text-secondary leading-relaxed mt-3 max-w-[14rem]">
              A transparent, structured approach from discovery to delivery and beyond.
            </p>
            ...
            <div className="flex flex-col gap-3">
                  ...
                  <Reveal key={title} delay={0.12 + i * 0.05}>
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <p className="text-sm text-text-secondary/80 group-hover:text-text-secondary transition-colors duration-300 leading-relaxed">
                          {text}
                        </p>
              ...
              <div className="mt-0.5 flex items-center justify-between rounded-lg border border-accent-indigo/10 bg-accent-indigo/[0.025] px-4 py-2.5">
                <p className="font-mono text-[11px] text-text-muted">
                  PROCESS · {STAGES.length} STAGES · CLEAR PATH
                </p>
                <div className="flex gap-1">
                  {STAGES.map((_, i) => (
                    <span
                      ...
                      style={{
                        width: i === 0 ? "1.25rem" : i === STAGES.length - 1 ? "1.25rem" : "0.5rem",
                        backgroundColor:
                          i === 0
                            ? "rgb(99 102 241 / 0.65)"
                            : i === STAGES.length - 1

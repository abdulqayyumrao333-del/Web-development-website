...
import { ArrowRight, Github, Sparkles, Rocket, MessageCircle, Send, Star, Code2, CheckCircle } from "lucide-react";
  ...
  return (
    <section className="relative w-full overflow-hidden py-20 sm:py-28">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-5 w-16 h-16 rounded-full border border-accent-indigo/5 animate-[spin_25s_linear_infinite]" />
      </div>

      <div className="relative mx-auto max-w-6xl px-6 flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <div className="relative overflow-hidden rounded-xl border border-accent-indigo/10 bg-bg-surface-1/50 p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-mono text-text-muted/40">24h response</span>
                </div>
              </div>
            </div>
          </div>

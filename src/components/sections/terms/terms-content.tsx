...
import { ArrowLeft, Shield, FileText, Scale, Gavel, Sparkles, AlertCircle, BookOpen, Globe, Mail } from "lucide-react";
import { Reveal } from "@/components/sections/reveal";
import { TERMS_DATA } from "@/config/terms";
...
const SECTION_ICONS: Record<string, any> = {
  ...
  "Use License": FileText,
  "Disclaimer": AlertCircle,
  "Limitations of Liability": Gavel,
  "Revisions and Errata": Sparkles,
  "External Links": Globe,
  "Governing Law": Scale,
  "Changes to Terms": BookOpen,
  "Contact Information": Mail,
};

export function TermsContent() {
  const { effectiveDate, lastUpdated, sections } = TERMS_DATA;
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <div className="relative mb-4">
              <h2 className="relative text-h2 font-semibold tracking-tight leading-tight">
                Terms &
                <br />
                <span className="text-accent-indigo">Conditions</span>
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="relative">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-accent-indigo/15 bg-accent-indigo/8">
                      <Scale className="h-6 w-6 text-accent-indigo" strokeWidth={1.75} />
                    </div>
                    <div>
              ...
              <div className="mt-2 flex items-center justify-between rounded-lg border border-accent-indigo/10 bg-accent-indigo/[0.025] px-4 py-2.5">
                <p className="font-mono text-[11px] text-text-muted">
                  TERMS · {sections.length} SECTIONS · LEGAL
                </p>

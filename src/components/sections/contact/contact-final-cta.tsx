...
import { ArrowRight, MessageCircle, FolderGit2, Download, Send, Sparkles, Rocket } from "lucide-react";
        ...
        <Reveal>
          <div className="lg:sticky lg:top-28">
            ...
            <div className="mt-8 hidden lg:flex flex-col gap-2">
              <a href="#contact-form" className="group inline-flex items-center gap-2 text-sm font-medium text-accent-indigo hover:text-accent-indigo/80 transition-colors">
              ...
              <a href={siteConfig.links.whatsapp} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 text-sm font-medium text-text-muted hover:text-text-primary transition-colors">
